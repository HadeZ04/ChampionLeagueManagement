...
const PlayerProfilePage = () => {
    ...
    if (!player) {
        return <div className="text-center py-12">Loading player profile...</div>;
    }
            ...
            <div className="grid md:grid-cols-3 gap-8">
                ...
                <div className="md:col-span-2">
                    <div className="uefa-card p-6">
                        <h2 className="text-xl font-bold mb-4 flex items-center"><BarChart2 className="mr-2" /> Season Statistics</h2>
                ...
                <div className="space-y-6">
                    <div className="uefa-card p-6">
                        ...
                        <p><Flag size={16} className="inline mr-2" />{player.nationality}</p>
                        <p><Calendar size={16} className="inline mr-2" />{player.dob}</p>
                        {/* ... Các thông tin khác ... */}
                    </div>
                    <div className="uefa-card p-6">
                        <h2 className="text-xl font-bold mb-4">Career History</h2>
